    ...
    <div className="grid gap-8">
      <section className="grid gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{t("adminUserHint")}</p>
        </div>
        <form
        ...
        >
          ...
          <Button
            type="submit"
            disabled={createUser.isPending || roles.isPending}
          >
                  ...
                  <select
                    ...
                    onChange={async (event) => {
                      ...
                      try {
                        ...
                        setError(
                          accessErrorMessage(mutationError, t("setRoleError"))
                        );
                      }
                    }}
                  >
